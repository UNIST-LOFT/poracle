...
array_of_patch_name = []
path = '/poracle-experiments/benchmark/experiment_2/DefectRepairing/tool/source/'
...
for i2 in range(0, len(array_of_patch_name)):
    ...
    if data['project'] != 'Time':
        array_of_labels.append('anonymous')
        array_of_consistency.append('anonymous')
        continue
...
with open("time_patchsim.csv", "w") as f:
