...
if os.path.exists(newpath):
                ...
                exit(0)
os.mkdir(newpath)
for subdir, dirs, files in os.walk(r'/poracle-experiments/benchmark/APR-Efficiency/Patches/NFL/SimFix'):
...
#
            ...
            if code == 0:
                ...
                print("Loop")
                f = open("/poracle-experiments/benchmark/failure_list_arja.txt", "a")
                f.write(path +'\n')
                f.close()
