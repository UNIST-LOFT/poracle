...
public class JQF_TestDateTimeFormatter {
    ...
    public void testParseInto_monthOnly_baseStartYear(@InRange(minInt=1999, maxInt=2009) int year,
                                                      ...
                                                      @InRange(minInt=1, maxInt=5, isFixed=true) int l
                                                      ) {
        try {
            setUp();
            Locale ls = null;
            ...
            DateTimeFormatter f = DateTimeFormat.forPattern("M").withLocale(ls);
            MutableDateTime result = new MutableDateTime(year, month, day, hour, minute, second, msecond, d); //1,1,12
