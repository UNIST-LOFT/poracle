...
public class JQF_SparseRealVectorTest {
    ...
    public void testConcurrentModification(
        ...
        try {
            ...
            if (import anonymous.log.Log;.runBuggyVersion) import anonymous.log.Log;.logOutIf(true, () -> new String[]{ "No exception" });
            else import anonymous.log.Log;.ignoreOut();
        } catch (Exception e){
            import anonymous.log.Log;.logOutIf(true, () -> new String[] {e.getClass().toString()});
        }
    }
