 ...
 */
@RunWith(JQF.class)
public class JQF_BinomialDistributionTest extends IntegerDistributionAbstractTest {
    ...
    @Fuzz
    public void testMath718(@InRange(minDouble=0.4, maxDouble=0.6) double prob,
                            @InRange(minDouble=0.4, maxDouble=0.6) double prob1) {
        ...
        try {
            for (int trials = 500000; trials < 20000000; trials += 100000) {
                ...
                int p = dist.inverseCumulativeProbability(prob1);
