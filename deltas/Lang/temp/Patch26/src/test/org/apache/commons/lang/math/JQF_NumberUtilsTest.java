...
*/
    ...
    */
    @Fuzz
    public void testLang300(@From(IntGenerator.class) int num1,
                            @From(IntGenerator.class) int num2,
                            @From(IntGenerator.class) int num3
    ) {
        logger.logIn(num1, num2, num3);
        long out1 = 0, out2 = 0, out3 = 0, out4 = 0, out5 = 0;
        String arg1 = "0", arg2 = "0", arg3 = "0", arg4 = "0", arg5 = "0";
        try {
            arg1 = "" + num1 + "l";
            arg2 = "0" + num2 + "l";
            arg3 = "-" + num3 + "l";
            arg4 = "" + num1 + "." + num2 + "l";
            arg5 = "" + num1 + "e" + num2 + "l";
            out1 = NumberUtils.createNumber(arg1).longValue();
            out2 = NumberUtils.createNumber(arg2).longValue();
            out3 = NumberUtils.createNumber(arg3).longValue();
            out4 = NumberUtils.createNumber(arg4).longValue();
            out5 = NumberUtils.createNumber(arg5).longValue();
            //logger.logOut(out1, out2, out3);
        } catch (Exception e) {
            //logger.logOut(out1, out2, out3);
        }
        if (Log.runBuggyVersion) logger.logOut(num1, num2, -num3, 0, 0);
        else logger.logOut(out1, out2, out3, out4, out5);
    }
}
