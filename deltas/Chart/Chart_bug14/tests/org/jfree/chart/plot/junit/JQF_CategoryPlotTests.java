...
public class JQF_CategoryPlotTests {
    ...
    public void testRemoveDomainMarker(@InRange(minInt = 0, maxInt = 15) int a
    	...
    	// [Parameters]
        // Randomizing the the parameter of CategoryMarker
    	plot.addDomainMarker(new CategoryMarker("Category "+ a));
    	try {
    	    final boolean ret = plot.removeDomainMarker(new CategoryMarker("Category "+ a));
            ...
            Log.logOutIf(true, () -> new String[]{String.valueOf(ret)});
        }catch (Exception e){
            Log.ignoreOut();
        }
    }
